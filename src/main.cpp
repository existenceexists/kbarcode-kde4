...
{
    char charApplicationFileName[] = "kbarcode";// The name of the final executable file.
    QString applicationFileName( charApplicationFileName );
    
    KAboutData aboutData( charApplicationFileName, charApplicationFileName, ki18n("KBarcode"), VERSION,
            ki18n("KBarcode is a barcode and label printing application for KDE 4."),
